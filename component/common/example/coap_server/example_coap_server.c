				   ...
				   coap_pdu_t *request, str *token, coap_pdu_t *response)
{
	...
	printf("\n[COAP_SERVER] received GET request\n");
				  ...
				  coap_pdu_t *request, str *token, coap_pdu_t *response)
{
	...
	printf("\n[COAP_SERVER] received GET time request\n");
				  ...
				  coap_pdu_t *request, str *token, coap_pdu_t *response)
{
	...
	printf("\n[COAP_SERVER] received PUT time request\n");
...
void hnd_delete_time(coap_context_t *ctx, struct coap_resource_t *resource, coap_address_t *peer,
					 coap_pdu_t *request, str *token, coap_pdu_t *response)
{
	printf("\n[COAP_SERVER] received DELETE time request\n");
				   ...
				   coap_pdu_t *request, str *token, coap_pdu_t *response)
{
	...
	printf("\n[COAP_SERVER] received GET async request\n");
...
#endif //#if defined(CONFIG_EXAMPLE_COAP_SERVER) && CONFIG_EXAMPLE_COAP_SERVER