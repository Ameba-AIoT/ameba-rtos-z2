...
#if LWIP_VERSION_MAJOR >= 2
	printf("\n\r[%d]DHCP assign ip = %d.%d.%d.%d\n", xTaskGetTickCount(), ip4_addr1(ip_2_ip4(&dhcps_network_id)), ip4_addr2(ip_2_ip4(&dhcps_network_id)),
...
#else
	printf("\n\r[%d]DHCP assign ip = %d.%d.%d.%d\n", xTaskGetTickCount(), ip4_addr1(&dhcps_network_id), ip4_addr2(&dhcps_network_id), ip4_addr3(&dhcps_network_id),
		   temp_ip);
