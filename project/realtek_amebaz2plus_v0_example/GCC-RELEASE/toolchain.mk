...
ifeq ($(findstring CYGWIN, $(OS)), CYGWIN)
	...
	TOOLCHAIN_FILENAME = asdk-6.5.0-cygwin-newlib-build-3574-i686_amebaz2.tar.bz2
	TOOLCHAIN_BITS = 32
endif
...
ifeq ($(findstring Linux, $(OS)), Linux)
	...
	TOOLCHAIN_FILENAME = asdk-6.5.0-linux-newlib-build-3574-x86_64_amebaz2.tar.bz2
	TOOLCHAIN_BITS = 64
endif

CODE_ANALYZE_PYTHON = $(shell python $(AMEBAZ2_GCCTOOLDIR)/code_analyze.py)
...
ifneq ("$(LBITS)", "$(TOOLCHAIN_BITS)")
	...
	@if [ ! -f ../../../tools/arm-none-eabi-gcc/$(TOOLCHAIN_FILENAME) ] ; then cat ../../../tools/arm-none-eabi-gcc/$(TOOLCHAIN_FILENAME)* > ../../../tools/arm-none-eabi-gcc/$(TOOLCHAIN_FILENAME); fi;
