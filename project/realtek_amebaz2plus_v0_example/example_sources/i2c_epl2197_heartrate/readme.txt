...
Connections
    1, I2C0 SDA (PA_20) to extended board's SDA (J21.2)
    2, I2C0 SCL (PA_19) to extended board's SCL (J21.1)
    3, Ameba 5V to extended board 3.3V (J22.8)
    4, Ameba ground to extended board ground (J22.11)
...
GCC:
    1, Please be sure to copy inc\heart_interface.h, inc\HRM_2197.h
    2, In project\realtek_amebaz2_v0_example\GCC-RELEASE\application.is.mk (for trustzone please change application.ns.mk), modify LIBFLAGS part by adding below line:
