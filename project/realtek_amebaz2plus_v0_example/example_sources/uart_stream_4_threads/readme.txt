...
This example shows:
    1, The RX thread 1 ready interrupt service routine is used to receive characters from the PC
    2, The RX thread 2 ready interrupt service routine is used to receive characters from the PC
    3, The TX thread 1 interrupt service routine will send characters to the PC.
    4, The TX thread 2 interrupt service routine will send characters to the PC.
    5, The main log will show how many bytes of data were transfered and recieved for each thread from start
